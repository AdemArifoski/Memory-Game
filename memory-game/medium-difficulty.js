...
createGame("imgContainer1", ".minion1","resetButton1", "timer1", "modalContainer1", "playAgainButton1", 8);
...
function changeLevel(level) {
  ...
  createGame(imgContainerId, minionClass, resetButton, timerId, modalContainerId, playAgainButtonId, numberCount);
